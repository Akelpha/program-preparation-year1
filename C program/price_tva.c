// Écrire un programme en langage C qui lit le prix hors taxe (HT) d'un article, le nombre d'articles et le taux de TVA. Le programme calcule ensuite le prix total TTC et affiche le résultat.
